        ...
        <header class="pb-2 vazir"> 
           <div class="d-flex align-items-center custom-bg">
              <a href="/" class="d-flex align-items-center text-decoration-none mx-3 my-2">
                   <img src="<?php echo e(asset('images/logo.png')); ?>" alt="لوگو" width="150" height="80" class="ms-2">   
              </a>
               <!-- hamburger-menu -->
              <button class="btn btn-outline-secondary d-lg-none me-auto ms-3" type="button"
                   ...
                   <img src="<?php echo e(asset('images/hamburger-menu.svg')); ?>" alt="منو" width="24" height="24">
              </button>
                 <!-- create -->
            ...
            <ul class="nav align-items-center">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="nav-item mx-3 my-2">
                    <a href="<?php echo e(route('categories.show', $category->id)); ?>" class="nav-link">
              ...
              <div class="offcanvas-header">
               ...
               <div class="offcanvas-body">
                  <ul class="navbar-nav mb-3">
                       ...
                       <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li class="nav-item">
                          <a href="<?php echo e(route('categories.show', $category->id)); ?>" class="nav-link"><?php echo e($category->name); ?></a>
                      </li>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </ul>
    ...
    <div class="container">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 vazir">
        ...
        <div class="col d-flex flex-column align-items-start">
          <a href="/" class="mb-3">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="لوگو" width="220" height="100">
          </a>
          ...
          <ul class="nav flex-column">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li class="nav-item mb-2 ">
                <a href="<?php echo e(route('categories.show', $category->id)); ?>" class="nav-link p-0 text-body-secondary">
                  <?php echo e($category->name); ?>
